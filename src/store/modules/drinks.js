const state = {
    ...
    categories: [
        ...
        {id: 3, name: 'Tea', desc: 'The tea-drinking habits of HK residents derive primarily the Cantonese traditions such as yum cha. This tradition is not only in terms of the tea itself, but also in terms of the underlying social and cultural values.'},
        {id: 4, name: 'Specials', desc: ''}
    ]
}
